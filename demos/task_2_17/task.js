...
function renderChart() {
  ...
  function drawRec() {
    ...
    if (v >= hl) {
      ov = 1;
    } else if (v <= 16="" ll)="" {="" ov="0;" }="" else="" -="" 50)="" (hl="" ll);="" var="" rec="document.createElement("div");" r="~~(255" *="" ov);="" g="~~(255" (1="" ov));="" 对="" 和="" 值的处理函数,="" 当位数少于两位时,="" 补齐="" function="" wrap(num)="" ox="num.toString(16)" return="" num="" <="" ?="" "0"="" +="" :="" ox;="" b="#" wrap(r)="" wrap(g)="" +"00";="" if="" (v=""> hl) {
      b = "#000000";
    }
    var h = p * maxHeight;
